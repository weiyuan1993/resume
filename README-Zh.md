...
擁有**1年網頁開發經驗**，並具備全端開發能力，曾於新創公司實習半年，有良好的團隊合作經驗及獨立開發能力


自己對於前端操作、畫面表現很有興趣，喜歡與客戶端互動的部分，常會因為畫面的小細節不喜歡而鑽研改進。大四時開始到外面公司實習，充分學習到網頁工程師所應具備的技能，培養了豐富的開發熱忱與經驗。


大學時因為[Codecademy](https://www.codecademy.com/)而踏入Web領域，從基本的HTML、CSS到JavaScript，發現自己漸漸喜歡上網頁開發，並能實做出一些小作品。擁有，並，
